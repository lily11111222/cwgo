...
public class MyPostActivity extends AppCompatActivity {
    ...
    private List<Post> list_item;
    private AllPostAdapter adapter = new AllPostAdapter();
    ...
    private Handler handler = new Handler(Looper.myLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            adapter.setInflater(getBaseContext());
...
//                }
    ...
    private Handler handlerPraAndCom = new Handler(Looper.myLooper()){
        @Override
        public void handleMessage(Message msg){
            if(msg.what == 0){
                adapter.notifyDataSetChanged();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_view = findViewById(R.id.lv_mypost);
